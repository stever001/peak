...
As of Phase 102, whose baseline is the committed Phase 101 commit `68ddc21` — *Exercise Phase 101
intake workflow*. Phase 102 is docs-only and DB-free, and changed none of these values:
...
Phases 87–102 changed no migration, table, or writer, so the first six values are unchanged since
