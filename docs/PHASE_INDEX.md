...
As of Phase 108, whose baseline is the committed Phase 107 commit `f107863` — *Create Phase 107 lab
evidence reference*. Phase 108 was DB-free and record-free and changed nothing in the table below.
Phase 107 wrote **one durable lab record** and changed no schema, model, enum, writer, allowlist,
...
Phases 87–108 changed no migration, table, or writer, so the first six values are unchanged since
