...
As of Phase 105, whose baseline is the committed Phase 104 commit `e809889` — *Exercise Phase 104
evidence normalization*. Phase 105 is docs-only and DB-free, and changed none of these values:
...
Phases 87–105 changed no migration, table, or writer, so the first six values are unchanged since
