...
As of Phase 109, whose baseline is the committed Phase 108 commit `01e5898` — *Exercise Phase 108
narrow reporting*. Phase 109 was read-only and record-free and changed nothing in the table below;
...
Phases 87–109 changed no migration, table, or writer, so the first six values are unchanged since
