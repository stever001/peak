...
As of Phase 110, whose baseline is the committed Phase 109 commit `026c479` — *Assess Phase 109 lab
packet assembly*. Phase 110 added one pure source module and one test, contacted no database, and
changed nothing in the table below. Phase 109 was read-only and record-free and changed nothing in the table below;
...
Phases 87–110 changed no migration, table, or writer, so the first six values are unchanged since
