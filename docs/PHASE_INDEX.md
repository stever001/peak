...
As of Phase 104, whose baseline is the committed Phase 103 commit `833c073` — *Close Phase 103
intake discovery seam*. Phase 104 is docs-only and DB-free, and changed none of these values:
...
Phases 87–104 changed no migration, table, or writer, so the first six values are unchanged since
