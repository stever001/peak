...
.PHONY: help validate validate-phase1 validate-phase2 validate-phase3 validate-phase4 install-dev

help: ## Show available targets
	@echo "Targets:"
	@echo "  make install-dev        Install dev dependencies ($(PYTHON) -m pip install -r requirements-dev.txt)"
	@echo "  make validate           Run all validation harnesses (Phase 1 + Phase 2 + Phase 3 + Phase 4)"
...
validate: validate-phase1 validate-phase2 validate-phase3 validate-phase4 ## Run all validation harnesses
